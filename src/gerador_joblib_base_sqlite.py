...
models = [
    ...
    (
        'KNN',
        make_pipeline(
            TfidfVectorizer(stop_words=stop_words_pt, lowercase=True),
...
melhor_modelo_nome = comparison.loc[comparison['test_acc'].idxmax(), 'name']
print(f"Melhor modelo individual: {melhor_modelo_nome}")
...
# Salva o ensemble completo (para uso em produção)
# NB
...
# Opcional: Salva modelos individuais (para análise/experimentação)
