...
from src.models.categoria import CategoriaModel, TarefaModel
...
def obter_dataset(db: Session) -> DatasetTarefas:  
    resultados = db.query(TarefaModel.descricao, CategoriaModel.nome)\
