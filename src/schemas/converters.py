...
from .categoria import CarregaCategoriaComboResponse
from .categoria import CarregaPainelUsuarioResponse
from .categoria import CategoriaCombo
...
class CategoriaConverter:
    ...
    def to_categoria_combo(
        ...
        for categoria in categoria_model:
            cat = CategoriaCombo(
                id=categoria.id, descricao=categoria.nome, selecionado=False,
            )
