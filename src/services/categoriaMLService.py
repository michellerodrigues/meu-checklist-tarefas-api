...
class CategoriaMLService:
    ...
    def _initialize_service(self):
        ...
        try:
            ...
            self.stop_words_custom = [
                ...
                'os', 'as', 'ao', 'à', 'para', 'por', 'com', 'não', 'se',
                'que', 'como', 'mas', 'meu', 'minha', 'em', 'num', 'dum'
            ]
    ...
    def _set_modelo(self):
        ...
        try:
            ...
            if self.conjuntoTreinamento is None:
                raise ValueError("Conjunto de treinamento não foi carregado corretamente")
            
                    # Teste predição simples
            try:
                sample_pred = pipeline.predict([self.conjuntoTreinamento.X_train.iloc[0]])
    ...
    def prever_categoria(self, tarefa: str, threshold: float = 0.05) -> str:
        ...
        try:
            ...
            if not hasattr(self, 'conjuntoTreinamento') or self.conjuntoTreinamento is None:
            ...
            return self.conjuntoTreinamento.label_encoder.inverse_transform([encoded])[0]
